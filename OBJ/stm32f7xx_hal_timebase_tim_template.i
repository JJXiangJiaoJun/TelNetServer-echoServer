#line 1 "..\\HALLIB\\STM32F7xx_HAL_Driver\\Src\\stm32f7xx_hal_timebase_tim_template.c"
...
#line 46 "..\\HALLIB\\STM32F7xx_HAL_Driver\\Src\\stm32f7xx_hal_timebase_tim_template.c"
...
HAL_StatusTypeDef HAL_InitTick (uint32_t TickPriority)
{
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) |= (0x00000010U)); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) & (0x00000010U)); ((void)(tmpreg)); } while(0);
