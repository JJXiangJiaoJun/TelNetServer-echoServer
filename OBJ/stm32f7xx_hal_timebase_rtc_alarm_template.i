#line 1 "..\\HALLIB\\STM32F7xx_HAL_Driver\\Src\\stm32f7xx_hal_timebase_rtc_alarm_template.c"
...
#line 66 "..\\HALLIB\\STM32F7xx_HAL_Driver\\Src\\stm32f7xx_hal_timebase_rtc_alarm_template.c"
...
#line 96 "..\\HALLIB\\STM32F7xx_HAL_Driver\\Src\\stm32f7xx_hal_timebase_rtc_alarm_template.c"
...
#line 133 "..\\HALLIB\\STM32F7xx_HAL_Driver\\Src\\stm32f7xx_hal_timebase_rtc_alarm_template.c"
  ...
  if(HAL_RCC_OscConfig(&RCC_OscInitStruct) == HAL_OK)
  {
    ...
    if(HAL_RCCEx_PeriphCLKConfig(&PeriphClkInitStruct) == HAL_OK)
    {
      ...
      ((&hRTC_Handle)->Instance ->ISR) = (~(((((uint32_t)0x00000100U)) | 0x00000080U)& 0x0000FFFF)|((&hRTC_Handle)->Instance ->ISR & 0x00000080U));
...
void HAL_RTC_AlarmAEventCallback(RTC_HandleTypeDef *hrtc)
{
  ...
  do{ (hrtc)->Instance ->WPR = 0xCA; (hrtc)->Instance ->WPR = 0x53; } while(0);
  ...
  do{ (hrtc)->Instance ->WPR = 0xFF; } while(0);
}
